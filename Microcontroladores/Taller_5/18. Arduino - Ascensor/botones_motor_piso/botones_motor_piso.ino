...
void moverAscensor(int pisoDestino, String mensajePiso, String nombreCompleto) {
  ...
  // Controlar el motor durante 1 segundo
...
void controlarMotor(String direccion) {
  // Encender el motor hacia la dirección especificada durante 1 segundo
  ...
  analogWrite(MOTOR_ENA, 200);  // Ajusta la velocidad según sea necesario
  delay(1700);
